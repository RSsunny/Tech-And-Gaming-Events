...
const Feature1 = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-5">
            ...
            <div className="flex-1 h-[300px] " data-aos ="fade-left" data-aos-mirror="true" data-aos-delay="100">
                <img className="h-full w-full " src={image22} alt="" />
            </div>
            <div className="flex-1" data-aos ="fade-left" data-aos-mirror="true" data-aos-delay="100">
