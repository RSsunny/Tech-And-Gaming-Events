...
const Feature2 = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-5 py-20 overflow-hidden">
            <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-20 overflow-hidden">
            <div className="flex-1 h-[300px] overflow-hidden " data-aos ="fade-right" data-aos-mirror="true" data-aos-delay="100">
                <img className="h-full w-full " src={image23} alt="" />
            </div>
            <div className="flex-1 overflow-hidden" data-aos ="fade-right" data-aos-mirror="true" data-aos-delay="100">
